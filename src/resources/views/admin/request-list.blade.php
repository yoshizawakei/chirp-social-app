...
@section("content")
    <div class="application-list-container">
        ...
        <div class="tab-navigation">
            <a href="{{ route('admin.correctionRequest.list', ['status' => 'pending']) }}"
                class="tab-button {{ request('status', 'pending') == 'pending' ? 'active' : '' }}">承認待ち</a>
            <a href="{{ route('admin.correctionRequest.list', ['status' => 'approved']) }}"
            ...
            <tbody>
                @forelse ($applications as $application)
                    <tr>
                        ...
                        <td><a href="{{ route('admin.correctionRequest.detail', $application->attendance->id) }}" class="detail-link">詳細</a></td>
                    </tr>
                @empty
                    <tr>
