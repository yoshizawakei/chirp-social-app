...
const handleShareClick = async () => {
    ...
    console.log("[handleShareClick] start");
    ...
    try {
        ...
        console.log("[handleShareClick] success, reset message");
        message.value = "";
    } catch (e) {
        console.error("[handleShareClick] 投稿エラー:", e);
        alert("投稿エラー: " + (e.message || "不明なエラーです"));
    } finally {
        console.log("[handleShareClick] finally, reset isPosting");
